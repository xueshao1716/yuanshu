...
export type WebsiteRun = {id: string; status: string; stage: string; startedAt: string; error?: string; requestedModel: string; resultVersion?: string; events: {stage: string; message: string; at: string}[]}
