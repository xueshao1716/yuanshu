...
- 网页母图：`frontend/public/portraits/yuanshu-staircase-v1.webp`，941×1672，67,042字节，不裁切。
- 网页立绘：`frontend/public/portraits/yuanshu-cutout-v1.webp`，432×768 RGBA，33,866字节；保留服务端alpha、裁空白边缘并缩小。未使用黑底色键试验产物。
